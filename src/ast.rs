...
/// The top-level structure containing all source files and cumulative segment sizes.
#[derive(Debug, Clone, PartialEq)]
pub struct Source {
    ...
    /// Enable auto-relaxation: automatically compress base instructions to RV32C equivalents
    pub relax: bool,
}
...
pub struct Line {
    ...
    /// The segment this line belongs to (text, data, or bss).
    pub segment: Segment,
    /// The offset from the beginning of the segment where this line's code/data is expected.
    pub offset: u32,
    /// The size of output generated by this line in bytes.
    pub size: u32,
    /// Resolved outgoing symbol references for this line.
    pub outgoing_refs: Vec<SymbolReference>,
}
